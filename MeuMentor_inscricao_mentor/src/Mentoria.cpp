...
Mentoria::Mentoria(const std::string codigoDisciplina, const std::string dataMentoria, const std::string docProficiencia,const double valor) : codigoDisciplina(codigoDisciplina), dataMentoria(dataMentoria), docProficiencia(docProficiencia), valor(valor){}
